...
function Login() {
  ...
  return (
    <div
      ...
      bg-[radial-gradient(circle,var(--color-subtext)_2px,transparent_2px)]
      bg-size-[25px_25px]"
    >
      <motion.div
      ...
      >
        ...
        <form className="mt-12" onSubmit={handleSubmit}>
          ...
          <input
            ...
            className="bg-background border w-full border-foreground/30 focus:ring-1 focus:ring-buttonbg focus:outline-none py-2 px-4 rounded-lg"
          ...
          <div className="relative">
            <input
              ...
              onChange={handleChange}
              className="bg-background border w-full border-foreground/30 focus:ring-1 focus:ring-buttonbg focus:outline-none py-2 px-4 rounded-lg pr-10"
