  ...
  return (
    <section className="min-h-screen flex items-center justify-center px-4 md:px-30">
      <motion.div
        ...
        className="w-230 h-75 md:h-83 lg:h-88 bg-background z-20 shadow-2xl shadow-foreground rounded-2xl p-7"
      >
        {/* Heading */}
        <motion.h1
        ...
        >
          Test strategies with historical and live market data, explore trends,
          and experiment with different investment styles using virtual
          portfolios. Build investor avatars, simulate decisions, and see how
          each strategy performs over time.
        </motion.h2>
